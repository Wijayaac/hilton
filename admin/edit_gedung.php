...
?>
                ...
                <div class="jumbotron bg-light typo-form">
                    <div class="container typo-form px-3">
                        <h4 class="mb-5 text-center">Form Pengubahan Data Gedung</h4>
                        <div class="row px-3">
                            <?php

$id = $_GET['id'];
$query = (mysqli_query($connect, "SELECT * FROM gedung WHERE kode_gedung='$id'"));

while ($data = mysqli_fetch_array($query)) {
    # code...
?>
                            <form class="form-horizontal px-3" action="update_gedung.php" method="POST">
                                <div class="row form-group px-3">
                                    ...
                                    <div class="col-10 mb-1">
                                        <input type="text" class="form-control typo-form" id="validationDefault01"
                                            placeholder="Masukkan Kode Kamar" required name="kode_gedung"
                                            value="<?= $data['kode_gedung']; ?>" readonly>
                                    </div>

        ...
        <div class="row">
            ...
            <div class="col-3 pt-4 pl-0 mb-0">
                <div class="jumbotron rounded">
                    <p class="h3 text-center"> Silahkan Login</p>
                    ...
                    <form class="form-group pt-5 form-typo" method="POST" role="form">
                        ...
                        <label for="my-input" class="mt-3">Password</label>
...
if (isset($_POST['user'])) {
    ...
    $rows = $rows = mysqli_num_rows($data);
    if ($rows == 1) {
        $_SESSION['username'] = $username;
        echo '<meta http-equiv="refresh" content="1;url=index.php">';
        // header("Location: index.php"); // Redirect user to index.php
    } else {
        echo " <h6 class='text-danger mt-1'> *Username dan Password salah</h6>";
    }


}
?>
                        <button class="btn btn-primary btn-block mt-3 footer-typo" type="submit">Login</button>
                        <div class="daftar mt-4 text-center">
                            <p>Belum Punya Akun ?</p>
                            <p>Silahkan Daftar disini <a class="text-link" href="register.php">Daftar Akun</a>
                            </p>
                        </div>
                    </form>
                </div>
